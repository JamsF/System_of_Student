	...
	<div class="col-lg-10">
		<div class="col-lg-2" style="padding-top: 50px;text-align: center;">
			<ul class="nav nav-pills nav-stacked">
			  ...
			  <li role="presentation" class="active"><a href="#">学生信息修改</a></li>
		...
		<div class="col-lg-10" style="padding-top: 30px;">
			<div class="page-header col-lg-12" style="margin-top: 0px;">
			  <h1><small>请直接输入修改后的学生信息</small></h1>
			</div>
			<div class="col-lg-8">
				<form action="../.././UpdateStu" method="post" class="form-horizontal text-left" name="Regist_form">
